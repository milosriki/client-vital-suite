          ...
          const contactsToUpsert = contacts
            ...
            .map((contact: any) => {
              ...
              return {
                ...
                // UTM Parameters - Critical for Facebook/Google attribution
                first_touch_source: props.hs_analytics_first_touch_converting_campaign || props.utm_source || props.hs_analytics_source,
                last_touch_source: props.hs_analytics_last_touch_converting_campaign || null,
